...
async function logoutAdminSilencioso() {
  ...
  try {
    if (email && deviceId) {
      await fetch('https://xeiynyycgedonuqhigay.supabase.co/functions/v1/admin-auth', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhlaXlueXljZ2Vkb251cWhpZ2F5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njc5Mjc0MDcsImV4cCI6MjA4MzUwMzQwN30.3IXys2JuMX_TtLrbcRZgcbRGImvh1f6mwDxV2bbtE4c'
        },
...
async function logoutAdmin() {
  ...
  try {
    ...
    const response = await fetch(
      'https://xeiynyycgedonuqhigay.supabase.co/functions/v1/admin-auth',
      {
        method: 'POST',
        headers: { 
          'Content-Type': 'application/json',
...
async function verificarSesionAdmin() {
  ...
  try {
    const response = await fetch(
      'https://xeiynyycgedonuqhigay.supabase.co/functions/v1/verify-session',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
async function forzarCerrarSesionRemota() {
  ...
  try {
    ...
    const response = await fetch(
      'https://xeiynyycgedonuqhigay.supabase.co/functions/v1/update-session',
      {
        method: 'POST',
        headers: { 
          'Content-Type': 'application/json',
